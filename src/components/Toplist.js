...
const Toplist = ({ toplist, inARowToplist, showToplist, setShowToplist }) => {
  ...
  return (
    ...
    >
      <h1 className="mb-8 text-shadow text-center">Bäst av dom bästa</h1>
      <button
      ...
      <div className="text-center mb-6">
        <button
          className={`
            ${listToShow === "points" ? "text-yellow-500 border rounded-full px-4 py-1" : "text-gray-500"
    } w-32`}
        ...
        <button
          className={`
          ${listToShow === "inARow" ? "text-yellow-500 border rounded-full px-4 py-1" : "text-gray-500"
  } w-32`}
